...
export async function handleAddProductForm() {
  ...
  addProductForm.addEventListener("submit", async (event) => {
    ...
    const productName = document.getElementById("productName").ariaValueMax;
    const productDescription =
      document.getElementById("productDescription").ariaValueMax;
    const productImageUrl = docume.getElementById("productImageURL").value;
